...
for f in *; do
  case "$f" in
    00_Administration|01_Core_Platform|02_Client_Projects|03_Sandbox_and_RnD|_archived|README.md|AGENTS_MANIFEST.md|SYSTEM_MANIFEST.md|AGENTS.md|ESTADO.md|.opencode|.devcontainer) ;;
