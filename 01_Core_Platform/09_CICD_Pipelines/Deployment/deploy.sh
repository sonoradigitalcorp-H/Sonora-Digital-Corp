...
declare -A MAP=(
  ...
  ["02_Client_Projects/Tu_Bandera_Froy/02_Source_Code/telegram_bot_tubandera.py"]="/opt/hermes/tubandera/telegram_bot_tubandera.py"
  ["02_Client_Projects/Tu_Bandera_Froy/02_Source_Code/guards.py"]="/opt/hermes/tubandera/guards.py"
