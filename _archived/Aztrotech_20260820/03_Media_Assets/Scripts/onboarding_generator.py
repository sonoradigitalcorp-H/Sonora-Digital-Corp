...
# CSS que usará Python format - escapar llaves simples con dobles
CSS_CSS = """{margin:0;padding:0;box-sizing:border-box}"""  # marcador placeholder
...
#skyCanvas{{position:absolute;top:0;left:0;width:100%;height:100%;z-index:-1;pointer-events:none;opacity:0.3}}
</style>
</head>
<body>
<div id="bg"></div>
...
const starsMat = new THREE.PointsMaterial({color: 0x00d4ff, size: 0.03});
...
def generate_onboarding(name: str, tenant: str = "Aztrotech", output_dir: str = None, configs: dict = None):
    ...
    # Fill template (using String.Template)
