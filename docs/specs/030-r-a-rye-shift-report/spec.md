# SPEC-030-R-A: Shift Report (agente shift-report)
...
Captura y genera reporte de turno RYE: ciclo, downtime, partes OK/NG, pendientes.

## 2. User Stories

- Como Iván, quiero reporte de turno en un mensaje
- Como supervisor, quiero ver pendientes y recurrencias

## 3. Functional Requirements

| ID | Requirement | Priority | Est. Hours |
|----|------------|----------|------------|
| FR1 | Formato reporte: ciclo, downtime, partes OK/NG, pendientes | P0 | 4 |
| FR2 | Guardar reporte en engram | P0 | 4 |
| FR3 | Alertar si downtime > 5% | P0 | 4 |
...
- tests/gherkin/rye-shift-report.feature
