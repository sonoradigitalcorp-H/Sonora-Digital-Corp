...
const SERVICES: Record<string, { name: string; desc: string; long: string; icon: string; color: string; features: string[] }> = {
  studio: {
  ...
  bot: {
    ...
    features: ["98 skills disponibles", "Reportes automáticos", "Gestión de contratos", "Revenue en tiempo real", "CRM de fans"],
  },
  crm: {
