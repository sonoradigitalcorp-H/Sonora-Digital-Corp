...
| Operational Simplicity | 1x | 8 | 2 archivos nuevos (monitor.py, session_db.py); 3 modificaciones menores; sin nuevas dependencias externas (psutil ya está en el sistema) |
