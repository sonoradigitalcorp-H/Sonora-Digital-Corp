-- Content Studio — Product schema (database: sdc_content)
-- Schema matches 009_content_system.sql but without FK to core.artists table.
-- artist_id is TEXT (references core.artists.id at application level).
