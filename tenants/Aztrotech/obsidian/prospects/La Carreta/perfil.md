...
- **Web**: lacarretahermosillo.com
- **Color de marca**: #FF6B35
- **Icono**: 🍽️
...
## Agentes Propuestos
- **Agente Reservaciones**: Agenda citas, confirma, recuerda (WhatsApp)
- **Agente Pedidos**: Toma pedidos, procesa, confirma (WhatsApp)
